...
export default function Contact() {
    ...
    return (
    <section className="bg-[#916a6e] px-5 py-32" id="contact">
      <div className="text-center md:w-[60%] mx-auto text-white">
        <h2 className="text-4xl font-bold mb-5 border-b-[5px] w-[200px] mx-auto border-white-600 pb-2">
          Contact Me
        </h2>
        <p>
        ...
        <p className="py-2">
          <span className="font-bold">Email:</span> yogithamuthappa@gmail.com
        </p>
        <div>
        <a
